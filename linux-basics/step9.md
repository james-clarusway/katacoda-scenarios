...
<pre>$ cp mycoolfile /home/clarusway/Documents/cooldocs</pre>

mycoolfile is the file you want to copy and /home/clarusway/Documents/cooldocs is where you are copying the file to.
...
<pre>$ cp *.jpg /home/clarusway/Pictures</pre>
...
<pre>$ cp -r Pumpkin/ /home/clarusway/Documents</pre>
...
<pre>$ cp -i mycoolfile /home/clarusway/Pictures</pre>

## Exercise

Copy over a couple of files, be careful not to overwrite anything important.

>>Q9: What flag do you need to specify to copy over a directory?<<
